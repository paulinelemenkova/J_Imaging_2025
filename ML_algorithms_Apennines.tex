...
\begin{figure}[H]
  \centering
      \includegraphics[width=0.99\textwidth]{Fig_soil.jpg} \\
     \caption{Soil types in Italy: 10 major categories generalised from the database with thematic maps showing soil regions of Italy, scaled 1:5,000,000. Map source: author. Software: QGIS}
  \label{figsoil}
\end{figure}
\vspace{-1em}
...
After data import and preprocessing which included radiometric calibration, geometric correction, speckle filtering and terrain correction, the images were first classified using the 'MaxLike' approach of the unsupervised classification which uses clustering, Figure \ref{figA1}. 
