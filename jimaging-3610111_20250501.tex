...
\begin{figure}[H]
  \centering
      \includegraphics[width=0.99\textwidth]{Fig_diagram1.jpg} \\
     \caption{Conceptual approach of project workflow. Diagram source: author. Software: GIMP, v. 3.0.2}
  \label{figDia1}
\end{figure}
