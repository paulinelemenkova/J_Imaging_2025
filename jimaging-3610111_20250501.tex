...
\end{enumerate}
By achieving these objectives, this study seeks to advance the methodologies used in environmental monitoring and contribute to the conservation and management of mountainous landscapes. 

%------------------------------->
\section{Study area}

Geographically, the study area covers the region of northern Italy and includes the provinces of Umbria, Marche, SE Toscana and S of Emilia-Romagna, Figure \ref{fig01}. 
...
Climate fluctuations affect annual average temperature (ca. 8.9\degree C), where the lowest values do dot exceed 8\degree C at the top mountains, while the highest temperature (10\degree C) is recorded  in the lowlands. The average annual maximum is 11.5\degree C, and minimum of 6.2\degree C which consider as moderate for this region \cite{ClimateChange}. The most common forest soils are cambisols with the bedrock consisting of sandstones and arenaceous marls (Geoportale Nazionale). Such types of soil are formed under the combination of topographic and climate setting including sufficient precipitation typical for the central Apennines, Figure \ref{figsoil}. The information on the soil types has been collected from the data base with thematic maps showing soil regions of Italy, scaled 1:5,000,000 \cite{LAbate}. 

\vspace{-1em}
\begin{figure}[H]
  \centering
      \includegraphics[width=0.99\textwidth]{Fig_02.jpg} \\
     \caption{Land cover types in Italy: 10 major categories generalised from the original 44 classes of Coordination of Information on the Environment Land Cover  Classification (CORINE CLC)  with the increased fragment of the study area. Data source: Copernicus, 2018. Map source: author. Software: QGIS}
  \label{fig02}
\end{figure}
\vspace{-1em}
...
\hspace{10pt}\makebox[0.99\linewidth][r]{%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.99\textwidth]{Fig_04e.jpg}
		\caption{27 September 2018}
	\end{subfigure}%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
...
\hspace{10pt}\makebox[0.99\linewidth][r]{%
	...
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.99\textwidth]{Fig_05c.jpg}
		\caption{14 March 2022}
	\end{subfigure}%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.99\textwidth]{Fig_05d.jpg}
		\caption{17 March 2023}
	\end{subfigure}%
}\\
\vfill \vspace{0.2mm}
\hspace{10pt}\makebox[0.99\linewidth][r]{%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.99\textwidth]{Fig_05e.jpg}
		\caption{27 September 2018}
	\end{subfigure}%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.98\textwidth]{Fig_05f.jpg}
		\caption{14 September 2019}
	\end{subfigure}%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.98\textwidth]{Fig_05g.jpg}
		\caption{6 September 2022}
	\end{subfigure}%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.98\textwidth]{Fig_05h.jpg}
		\caption{3 October 2023}
	\end{subfigure}%
}
...
%\multirow{2}{*}{\textbf{Year}} &\multicolumn{3}{c}{\makecell{\textbf{Cohen's Kappa}\\ \textbf{Quantification of Agreement} }}&  \multicolumn{3}{c}{\textbf{F-1 Score of Predictive Performance}}\\
 ...
 %   \midrule
   2018 & 0.73 & 0.78 & 0.84  & 0.78 & 0.82 & 0.92\\
   2019 & 0.73 & 0.73 & 0.82  & 0.77 & 0.84 & 0.91 \\
   2022 & 0.71 & 0.74 & 0.81 & 0.77 & 0.79 & 0.92 \\
   2023 & 0.80 & 0.81 & 0.83  & 0.81 & 0.81 & 0.95\\
 \midrule
    2018 & 0.73 & 0.78 & 0.84  & 0.78 & 0.82 & 0.92\\
    2019 & 0.73 & 0.73 & 0.82  & 0.77 & 0.84 & 0.91 \\
    2022 & 0.71 & 0.74 & 0.81 & 0.77 & 0.79 & 0.92 \\
...
\caption{Satellite images on 2019 classified by four algorithms (RF, SVM, DT and MLPC) for spring and autumn periods.}\label{fig07}
\end{figure}
\vspace{-0.5em}
...
\hspace{10pt}\makebox[0.99\linewidth][r]{%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.98\textwidth]{Fig_08a}
		\caption{Spring RF}
	\end{subfigure}%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.98\textwidth]{Fig_08b}
		\caption{Spring SVM}
	\end{subfigure}%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.99\textwidth]{Fig_08c}
		\caption{Spring DT}
	\end{subfigure}%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.99\textwidth]{Fig_08d}
		\caption{Spring MLPC}
	\end{subfigure}%
}\\
\vfill \vspace{0.2mm}
\hspace{10pt}\makebox[0.99\linewidth][r]{%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.99\textwidth]{Fig_08e}
		\caption{Autumn RF}
	\end{subfigure}%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.98\textwidth]{Fig_08f}
		\caption{Autumn SVM}
	\end{subfigure}%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.98\textwidth]{Fig_08g}
		\caption{Autumn DT}
	\end{subfigure}%
	\begin{subfigure}[b]{.25\textwidth}
		\centering
			\includegraphics[width=0.98\textwidth]{Fig_08h}
		\caption{Autumn MLPC}
	\end{subfigure}%
}
\caption{Satellite images on 2022 classified by four algorithms (RF, SVM, DT and MLPC) for spring and autumn periods.}\label{fig08}
\end{figure}
\vspace{-0.5em}
